...
def preprocessing_for_barchart(df_meta_with_value, reading_interval_in_mins=10):
    ...
    df_grouped_working_hours_multiple_period = df_meta_with_value.groupby(["day_of_month", 'out_of_hours', "period"]).sum()["W"] * reading_to_mwh_parameter  # Div 1000 for convertion to MWh
